...
public class RegisterPage extends Util {//RegisterPage is sub class of Util class
    ...
    //Create a variable for store xpath value.
    private By _clickOnRegisterSubmitButton = By.xpath("//button[@id = \"register-button\"]");

    private By clickOnRegisterContinueButton = By.xpath("//a[@class = \"button-1 register-continue-button\"]");

    public void verifyUserIsOnRegisterPage(){
        //assert equals for expect URl and actual URl
       // Assert.assertTrue(getCurrentUrl("register"),"User Is Not Register Page");
        //Assert.assertEquals(getUrl(),assertUrl("sdjjd"));
        Assert.assertTrue(getCurrentUrl("register"),"User Is Not Register Page");
        sleep(5);
    }
    public void userEntersRegistationDetails(){
        //wait for 10 second for clickable
        waitUntilElementClickable(_selectGender,30);
        //Click the variable
        clickOnElement(_selectGender);
        sleep(3);//sleep 3 second
        //wait for 10 second for clickable
        waitUntilElementClickable(_firstName,30);
        //Type Text First name (Text Box).
        typeText(_firstName,loadProp.getProperty("firstName"));
        //wait for 10 second for clickable
        waitUntilElementClickable(_lastName,30);
        ...
        waitUntilElementClickable(_newsSletter,30);
        //Click the variable
    ...
    public void clickOnRegisterSubmitButton(){
        //wait for 10 second for clickable
        waitUntilElementClickable(_clickOnRegisterSubmitButton,30);
        //Click the variable
    ...
    public void clickOnRegisterContinueButton(){
        ...
        waitUntilElementClickable(clickOnRegisterContinueButton,30);
        clickOnElement(clickOnRegisterContinueButton);
