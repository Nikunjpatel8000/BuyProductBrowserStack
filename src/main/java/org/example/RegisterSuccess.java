...
public class RegisterSuccess extends Util {//RegisterSuccessPage is sub class of Util class
    ...
    String _expectRegisterSuccessMassage = "Your registration completed";



    public void verifyUserRegistrationSuccessfully() {
        //assert equals for expect and actual result
       Assert.assertEquals(getTextFromElement(_registerSuccessMassage), _expectRegisterSuccessMassage, "Your Registration Not Completed");
        //sout get text value
